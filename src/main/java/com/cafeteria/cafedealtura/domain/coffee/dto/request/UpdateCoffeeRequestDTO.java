...
/**
 * DTO para la actualización de un café existente.
 * Incluye validaciones para todos los campos requeridos.
 * Similar a CreateCoffeeRequestDTO pero usado específicamente para
 * actualizaciones.
 */
public class UpdateCoffeeRequestDTO {
    ...
    public UpdateCoffeeRequestDTO() {
    }

    public UpdateCoffeeRequestDTO(String name, String description, Double price, String origin) {
        this.name = name;
